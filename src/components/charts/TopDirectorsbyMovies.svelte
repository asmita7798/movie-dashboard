<script>
  ...
  function drawChart() {
    ...
    const width = 900;   // Logical width for SVG viewBox
    const height = 400;
    ...
    const svg = d3.select(container)
      ...
      .attr('height', height)             // Fixed height for alignment
    ...
    svg.append('text')
      ...
      .attr('y', -40)
      .attr('text-anchor', 'middle')
      .text(`Top Director per Decade (Total Movies)`)
      .attr('fill', '#facc15')
